/*
 *
 * TurbineChargingPortScreen.java
 *
...
public class TurbineChargingPortScreen
    ...
    public TurbineChargingPortScreen(ChargingPortContainer<MultiblockTurbine, IMultiblockTurbineVariant, TurbineChargingPortEntity> container,
        ...
        super(container, inventory, title, CommonLocations.TURBINE.buildWithSuffix("part-forgechargingport"));
    }

    //region AbstractMultiblockScreen

    @Override
    protected MachineStatusIndicator createStatusIndicator(ChargingPortContainer<MultiblockTurbine, IMultiblockTurbineVariant, TurbineChargingPortEntity> container) {
