...
public class EnergizerChargingPortContainer
    ...
    private EnergizerChargingPortContainer(boolean isClientSide, int windowId, Inventory playerInventory,
                                           EnergizerChargingPortEntity port) {

        super(isClientSide, windowId, Content.ContainerTypes.ENERGIZER_CHARGINGPORT.get(), playerInventory, port);
