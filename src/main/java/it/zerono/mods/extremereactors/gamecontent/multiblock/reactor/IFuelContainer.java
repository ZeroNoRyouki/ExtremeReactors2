...
public interface IFuelContainer {
    ...
    ReactantStackData getFuelStackData(int sampleFrequency, ModContainer container);

    ReactantStackData getWasteStackData(int sampleFrequency, ModContainer container);
}
