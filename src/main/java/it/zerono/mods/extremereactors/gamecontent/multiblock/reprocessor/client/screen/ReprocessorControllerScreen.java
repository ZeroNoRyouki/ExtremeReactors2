...
//        this.addPatchouliHelpButton(PatchouliCompat.HANDBOOK_ID, ExtremeReactors.newID("reactor/part-controller"), 1);
        ...
        this._energyBar.setTooltips(ImmutableList.of(
                new TranslatableComponent("gui.bigreactors.reprocessor.controller.energybar.line1").setStyle(STYLE_TOOLTIP_TITLE),
                new TranslatableComponent("gui.bigreactors.reprocessor.controller.energybar.line2a").setStyle(STYLE_TOOLTIP_VALUE)
                ...
                new TranslatableComponent("gui.bigreactors.reprocessor.controller.energybar.line3a").setStyle(STYLE_TOOLTIP_VALUE)
        ...
        final BindableTextComponent<Integer> fluidAmount = new BindableTextComponent<>(
                amount -> new TextComponent(CodeHelper.formatAsMillibuckets(amount)).setStyle(STYLE_TOOLTIP_VALUE));
        ...
        this._fluidBar.setTooltips(ImmutableList.of(
                new TranslatableComponent("gui.bigreactors.reprocessor.controller.coolantbar.line1").setStyle(STYLE_TOOLTIP_TITLE),
                new TranslatableComponent("gui.bigreactors.reactor.controller.coreheatbar.line2").setStyle(STYLE_TOOLTIP_VALUE),
                new TranslatableComponent("gui.bigreactors.reprocessor.controller.coolantbar.line3a").setStyle(STYLE_TOOLTIP_VALUE)
                ...
                new TranslatableComponent("gui.bigreactors.reprocessor.controller.coolantbar.line4a").setStyle(STYLE_TOOLTIP_VALUE)
