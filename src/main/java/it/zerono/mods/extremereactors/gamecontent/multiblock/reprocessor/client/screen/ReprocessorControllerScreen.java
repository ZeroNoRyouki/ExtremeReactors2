...
public class ReprocessorControllerScreen
    ...
    protected void onScreenCreate() {
        ...
        btn.setTooltips(ImmutableList.of(
                Component.translatable("gui.bigreactors.reprocessor.controller.voidfluid.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                TEXT_EMPTY_LINE,
                Component.translatable("gui.bigreactors.reprocessor.controller.voidfluid.line2"))
        );
