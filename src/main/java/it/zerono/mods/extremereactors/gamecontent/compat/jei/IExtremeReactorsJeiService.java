...
public interface IExtremeReactorsJeiService {
    ...
    ModDependencyServiceLoader<IExtremeReactorsJeiService> SERVICE = new ModDependencyServiceLoader<>("jei",
            IExtremeReactorsJeiService.class, FallbackExtremeReactorsJeiService::new);
