...
public class TurbineSensorSettingData
    ...
    public static TurbineSensorSettingData of(ModContainer container, boolean isClientSide,
                                              Supplier<@NotNull Supplier<TurbineSensorSetting>> serverSideGetter) {
    ...
    private TurbineSensorSettingData(Supplier<@NotNull Supplier<TurbineSensorSetting>> serverSideGetter) {
