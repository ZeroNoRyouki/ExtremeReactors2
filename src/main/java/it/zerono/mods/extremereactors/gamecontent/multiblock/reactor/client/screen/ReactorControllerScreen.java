...
public class ReactorControllerScreen
    ...
    protected void onScreenCreate() {
        ...
        final BindableTextComponent<Double> coreHeatText = new BindableTextComponent<>(
                heat -> new StringTextComponent(String.format("%.0f C", heat)).setStyle(CommonConstants.STYLE_TOOLTIP_VALUE));
        ...
        this._coreHeatBar.setTooltips(ImmutableList.of(
                new TranslationTextComponent("gui.bigreactors.reactor.controller.coreheatbar.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
        ...
        this._casingHeatBar.setTooltips(ImmutableList.of(
                new TranslationTextComponent("gui.bigreactors.reactor.controller.casingheatbar.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
        ...
        if (this._reactorMode.isPassive()) {
            ...
            this._lblEnergyRatio.setTooltips(ImmutableList.of(
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.energyratio.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.energyratio.line2a").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE)
            ...
            this._coolantBar.setTooltips(ImmutableList.of(
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.coolantbar.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                    ...
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.coolantbar.line3a").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE)
                            .append(new TranslationTextComponent("gui.bigreactors.reactor.controller.coolantbar.line3b")),
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.coolantbar.line4a").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE)
            ...
            this._vaporBar.setTooltips(ImmutableList.of(
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.vaporbar.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.vaporbar.line2").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE),
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.vaporbar.line3a").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE)
                            .append(new TranslationTextComponent("gui.bigreactors.reactor.controller.vaporbar.line3b")),
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.vaporbar.line4a").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE)
            ...
            final BindableTextComponent<Double> vaporGeneratedText = new BindableTextComponent<>(
                    generated -> new StringTextComponent(String.format("%.2f %s", generated / 1000.0, "B")).setStyle(CommonConstants.STYLE_TOOLTIP_VALUE));
            ...
            this._lblVaporRatio.setTooltips(ImmutableList.of(
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.vaporratio.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                    new TranslationTextComponent("gui.bigreactors.reactor.controller.vaporratio.line2a").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE)
        ...
        this._lblFuelUsage.setTooltips(
                new TranslationTextComponent("gui.bigreactors.reactor.controller.fuelusage.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                TEXT_EMPTY_LINE,
        ...
        this._lblFuelRichness.setTooltips(
                new TranslationTextComponent("gui.bigreactors.reactor.controller.fuelrichness.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                TEXT_EMPTY_LINE,
        ...
        btn.setTooltips(ImmutableList.of(
                        new TranslationTextComponent("gui.bigreactors.reactor.controller.voidreactants.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                        TEXT_EMPTY_LINE,
        ...
        swp.setTooltips(ImmutableList.of(
                new TranslationTextComponent("gui.bigreactors.reactor.controller.wasteeject.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
        ...
        scram.setTooltips(new TranslationTextComponent("gui.bigreactors.reactor.controller.scram.line1").setStyle(CommonConstants.STYLE_TOOLTIP_TITLE),
                TEXT_EMPTY_LINE,
    ...
    private static final ITextComponent TEXT_AUTOMATIC_WASTE_EJECT = new TranslationTextComponent("gui.bigreactors.reactor.controller.wasteeject.mode.automatic").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE);
    private static final ITextComponent TEXT_MANUAL_WASTE_EJECT = new TranslationTextComponent("gui.bigreactors.reactor.controller.wasteeject.mode.manual").setStyle(CommonConstants.STYLE_TOOLTIP_VALUE);
