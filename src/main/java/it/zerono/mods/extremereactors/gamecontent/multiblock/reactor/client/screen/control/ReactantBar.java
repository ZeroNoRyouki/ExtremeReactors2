...
public class ReactantBar
    ...
    private static MutableComponent formatFuelRodsCount(int count) {
        return TextHelper.literal("%d", text -> text.withStyle(ChatFormatting.DARK_AQUA, ChatFormatting.BOLD), count);
    }
    ...
    private static MutableComponent formatMaxCapacity(int capacity) {
        return TextHelper.literal(CodeHelper.formatAsMillibuckets(capacity),
                text -> text.withStyle(ChatFormatting.DARK_AQUA, ChatFormatting.BOLD), capacity);
    }
