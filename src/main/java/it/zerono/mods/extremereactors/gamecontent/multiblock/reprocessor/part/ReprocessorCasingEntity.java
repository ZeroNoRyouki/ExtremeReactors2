...
public class ReprocessorCasingEntity
    ...
    public boolean isGoodForPosition(PartPosition position, IMultiblockValidator validatorCallback) {
        return position.isFrame() || position.isVerticalFace() || super.isGoodForPosition(position, validatorCallback);
    }
