...
public class ReprocessorRecipeCategory
    ...
    public void setIngredients(final ReprocessorRecipe recipe, final IIngredients ingredients) {
        ...
        if (!recipeFluid.isEmpty()) {
            ...
            this._fluidBarTooltips.add(new TextComponent(String.format("%d mB", recipeFluid.getAmount()))
        ...
        this._powerBarTooltips.add(new TranslatableComponent("compat.bigreactors.jei.common.recipecategory.energy.tooltip.title")
                .setStyle(CommonConstants.STYLE_TOOLTIP_TITLE));
