...
public class ReactorFuelRodModel
    ...
    public TextureAtlasSprite getParticleIcon() {
        return this._subTypes[0]._baseModel.getParticleIcon(EmptyModelData.INSTANCE);
    }

    @Override
    public TextureAtlasSprite getParticleIcon(@Nonnull IModelData modelData) {
        ...
        return this._subTypes[subType]._baseModel.getParticleIcon(EmptyModelData.INSTANCE);
    }
