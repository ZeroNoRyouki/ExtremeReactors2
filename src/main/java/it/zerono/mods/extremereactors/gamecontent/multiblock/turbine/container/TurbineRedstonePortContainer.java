...
public class TurbineRedstonePortContainer
    ...
    private TurbineRedstonePortContainer(boolean isClientSide, int windowId, Inventory playerInventory,
                                         TurbineRedstonePortEntity port) {
        super(isClientSide, windowId, playerInventory, port, Content.ContainerTypes.TURBINE_REDSTONEPORT.get(), TurbineSensorSettingData::of);
    }

    public TurbineRedstonePortContainer(int windowId, Inventory playerInventory,
                                        TurbineRedstonePortEntity port) {
        this(false, windowId, playerInventory, port);
    }

    public TurbineRedstonePortContainer(int windowId, Inventory playerInventory, FriendlyByteBuf networkData) {
