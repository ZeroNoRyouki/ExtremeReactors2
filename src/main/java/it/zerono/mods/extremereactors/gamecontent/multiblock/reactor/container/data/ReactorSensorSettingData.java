...
public class ReactorSensorSettingData
    ...
    public static ReactorSensorSettingData of(ModContainer container, boolean isClientSide,
                                              Supplier<@NotNull Supplier<ReactorSensorSetting>> serverSideGetter) {
    ...
    private ReactorSensorSettingData(Supplier<@NotNull Supplier<ReactorSensorSetting>> serverSideGetter) {
