...
public class ReprocessorGlassEntity
    ...
    public ReprocessorGlassEntity(final BlockPos position, final BlockState blockState) {
        super(Content.TileEntityTypes.REPROCESSOR_GLASS.get(), position, blockState);
    }
