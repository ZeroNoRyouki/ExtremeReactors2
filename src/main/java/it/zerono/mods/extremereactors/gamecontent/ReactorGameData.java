...
final class ReactorGameData {
    ...
    private static void registerModerators() {
        ...
        //blockTitanium
        ModeratorsRegistry.registerSolid("forge:storage_blocks/draconium", 0.59f, 0.88f, 1.60f, 3.3f);
        ModeratorsRegistry.registerSolid("forge:storage_blocks/draconium_awakened", 0.76f, 0.88f, 1.78f, 4.8f);
        ModeratorsRegistry.registerSolid("forge:storage_blocks/graphite", 0.10f, 0.50f, 2.00f, IHeatEntity.CONDUCTIVITY_GOLD);

        // Thermal Extra
        ModeratorsRegistry.registerSolid("forge:storage_blocks/dragonsteel", 0.55f, 0.81f, 1.46f, IHeatEntity.CONDUCTIVITY_SILVER);
        ModeratorsRegistry.registerSolid("forge:storage_blocks/twinite", 0.50f, 0.78f, 1.42f, IHeatEntity.CONDUCTIVITY_COPPER);
        ModeratorsRegistry.registerSolid("forge:storage_blocks/shellite", 0.52f, 0.78f, 1.42f, IHeatEntity.CONDUCTIVITY_GOLD);

        // allthemodium
        ModeratorsRegistry.registerSolid("forge:storage_blocks/allthemodium", 0.697f, 0.942f, 3.84f, 3.65f);
        ModeratorsRegistry.registerSolid("forge:storage_blocks/vibranium", 0.24f, 0.81f, 7.47f, 4.38f);
        ModeratorsRegistry.registerSolid("forge:storage_blocks/unobtainium", 0.972f, 0.91f, 3.074f, IHeatEntity.CONDUCTIVITY_GRAPHENE);
