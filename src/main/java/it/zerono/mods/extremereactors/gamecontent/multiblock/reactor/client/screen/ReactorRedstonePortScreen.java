        ...
        builder.addSensor(ReactorSensorType.inputActive, CommonIcons.ButtonSensorInputActivate, CommonIcons.ButtonSensorInputActivateActive)
                ...
                .addSensor(ReactorSensorType.inputSetControlRod, CommonIcons.ButtonSensorInputSetControlRod, CommonIcons.ButtonSensorInputSetControlRodActive)
                    .addBehavior(SensorBehavior.SetFromSignal)
                        .addPercentageField("gui.bigreactors.reactor.redstoneport.sensortype.inputsetcontrolrod.whileon", "inputSetControlRodWhileOn")
                        .addPercentageField("gui.bigreactors.reactor.redstoneport.sensortype.inputsetcontrolrod.whileoff", "inputSetControlRodWhileOff")
                        .build()
                    .addInputLessBehavior(SensorBehavior.SetFromSignalLevel)
                    .addBehavior(SensorBehavior.SetOnPulse)
                        .addPercentageField("gui.bigreactors.reactor.redstoneport.sensortype.inputsetcontrolrod.setto", "inputSetControlRodSetTo")
                        .build()
                    .addBehavior(SensorBehavior.AugmentOnPulse)
                        .addPercentageField("gui.bigreactors.reactor.redstoneport.sensortype.inputsetcontrolrod.insertby", "inputSetControlRodInsertBy")
                        .build()
                    .addBehavior(SensorBehavior.ReduceOnPulse)
                        .addPercentageField("gui.bigreactors.reactor.redstoneport.sensortype.inputsetcontrolrod.retractby", "inputSetControlRodRetractBy")
                        .build()
                    .build()
                .addSeparator()
