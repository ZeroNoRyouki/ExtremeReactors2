...
public class ReactorRedstonePortContainer
    ...
    private ReactorRedstonePortContainer(boolean isClientSide, int windowId, Inventory playerInventory,
                                         ReactorRedstonePortEntity port) {

        super(isClientSide, windowId, playerInventory, port, Content.ContainerTypes.REACTOR_REDSTONEPORT.get(), ReactorSensorSettingData::of);
