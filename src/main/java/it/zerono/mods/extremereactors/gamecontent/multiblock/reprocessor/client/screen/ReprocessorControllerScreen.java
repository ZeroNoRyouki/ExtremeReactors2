...
public class ReprocessorControllerScreen
    ...
    public ReprocessorControllerScreen(final ReprocessorControllerContainer container, final PlayerInventory inventory,
        ...
        this._progressBar.setBarSprite(new SpriteTextureMap(ExtremeReactors.newID("textures/gui/multiblock/reprocessor_controller_arrow_filled.png"), 16, 32)
    ...
    private void onVoidFluid(final Button button, final Integer mouseButton) {
        this.sendCommandToServer(ReprocessorControllerEntity.COMMAND_VOID_FLUID);
    }
