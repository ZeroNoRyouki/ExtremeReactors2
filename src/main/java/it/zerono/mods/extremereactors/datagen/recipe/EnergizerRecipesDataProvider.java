...
public class EnergizerRecipesDataProvider
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> builder) {
        ...
        this.port(builder, "powerport_fe_active", Content.Items.ENERGIZER_POWERPORT_FE_ACTIVE, () -> Items.REDSTONE_BLOCK,
    ...
    private void computerPort(Consumer<FinishedRecipe> builder) {
