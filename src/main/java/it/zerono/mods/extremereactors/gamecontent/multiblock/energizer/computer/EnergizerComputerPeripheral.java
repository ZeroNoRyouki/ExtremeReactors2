...
public class EnergizerComputerPeripheral
    ...
    public void populateMethods(
            final Consumer<@NotNull ComputerMethod<MultiblockComputerPeripheral<MultiBlockEnergizer, EnergizerComputerPortEntity>>> methodConsumer) {
    ...
    private void addEnergyMethod(Consumer<@NotNull ComputerMethod<MultiblockComputerPeripheral<MultiBlockEnergizer, EnergizerComputerPortEntity>>> methodConsumer,
