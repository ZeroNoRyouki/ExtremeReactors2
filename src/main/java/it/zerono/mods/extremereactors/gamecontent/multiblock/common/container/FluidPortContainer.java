...
public class FluidPortContainer<Controller extends AbstractFluidGeneratorMultiblockController<Controller, V> & IMultiblockMachine & IActivableMachine,
    ...
    private FluidPortContainer(boolean isClientSide, final int windowId,
                               final MenuType<? extends FluidPortContainer<Controller, V, T>> type,
                               final Inventory playerInventory, final T port) {

        super(isClientSide, 5, ContainerFactory.EMPTY, type, windowId, playerInventory, port);
        ...
        this.ACTIVE = BooleanData.of(this, () -> controller.isMachineActive());
        //noinspection Convert2MethodRef
