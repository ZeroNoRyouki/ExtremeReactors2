...
public class Energizer {
    ...
    public final ForgeConfigSpec.IntValue maxEnergizerHeight;
    public final ForgeConfigSpec.IntValue maxEnergizerSize;

    Energizer(ForgeConfigSpec.Builder builder) {
